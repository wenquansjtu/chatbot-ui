...
AS $$
DECLARE
  project_url TEXT := 'https://blnamczglqvlmchqnicc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJsbmFtY3pnbHF2bG1jaHFuaWNjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0OTUyMTE2NSwiZXhwIjoyMDY1MDk3MTY1fQ.27AC-3Mkhp-eLGDpNUEx-VxVn8zE-y2CO2vhTU3VOoM'; -- full access needed for http request to storage
