    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <TextareaAutosize
          ...
          placeholder="Hello, I'm AgentNet — a unified settlement and coordination layer for AI Agents. I help bridge the gaps between different models and systems, enabling secure, efficient, and trustworthy collaboration across intelligent services."
